...
import com.clickretina.skillforge.theme.FreePillBg
import com.clickretina.skillforge.theme.FreePillText
import com.clickretina.skillforge.theme.LockedPillBg
import com.clickretina.skillforge.theme.LockedPillText
...
fun FreeLockPill(isFree: Boolean, modifier: Modifier = Modifier) {
    ...
    val label = if (isFree) "FREE" else "PRICE"
